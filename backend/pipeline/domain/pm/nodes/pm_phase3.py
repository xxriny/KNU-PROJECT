...
from pipeline.core.schemas import RTMBuilderOutput
from pipeline.core.utils import call_structured_with_thinking, get_llm
...
def rtm_builder_node(state: PipelineState) -> dict:
    ...
    try:
        ...
        for correction_attempt in range(2):
            ...
            if quality_error is None or action_type == "REVERSE_ENGINEER":
                break  # 품질 통과 또는 역공학 모드 시에는 엄격한 의존성 검사 생략
