const LAYER_ORDER = ["Presentation", "Application", "Domain", "Infrastructure", "Security", "Unknown"];
...
function getLayerX(layer, customOrder = []) {
...
function buildDynamicLayerXMap(grouped, order = LAYER_ORDER, options = {}) {
...
function compactPathLabel(text = "") {
